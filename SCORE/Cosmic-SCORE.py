...
seed = 21921
starting_node = None # starting node in the determination of the Eulerian circuit, if None, starts from the highest degree node
tablature = True
engine = 'neato'
# engine = 'dot'
# engine = 'fdp'
...
selection = {
    ...
    'MH'  : [[None],[None],['null','accel','rallen']],
    'MF'  : [[None],[None],['null','accel','rallen','legato','long']],
...
for sec in input_sec:
    ...
    if starting_node == None:
        starting_node = sorted(Gx.degree, key=lambda x: x[1], reverse=True)[0][0]
